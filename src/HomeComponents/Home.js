...
function Home(props) {
	...
	const handleSubmit = (e) => {
		e.preventDefault();
		props.history.push(`/records/${input}`);
		setInput('');
	}
...
{/* The third page -- Explain Ethereum Tech  --------------------------------------------------------------------*/}
	 <div className="test">	
			<div className="block ">
				<h1 className="testTitle wow jello">區塊鍊技術應用</h1>
			</div>	
			<div>
			...
			<div className="block">
				<p className="testPara wow slideInUp">
						農產品運銷公司的員工可以登入帳號，與智能合約互動、傳送交易。透過區塊鏈不可竄改的特性，可確保交易資料的正確性，並在農產品發生問題時，能找到負責人與相關時間資訊。管理者同樣可以透過登入帳號來達到即時的供應鏈管理，利用區塊練監控每一批農產品的處理進度，做成本及存貨管理。
				</p>
			</div>
...
<div className="processBg">
	...
	<div className="box exp6">
		<div className="box-hover-text">
			<p className="box-body">客戶接收貨品，驗收入庫上架</p>
		</div>
	</div>
...
{/* The fifth page -- About the farms-carousel ------------------------------------------------------------------*/}
	 <div style={{backgroundColor: 'rgb(27, 19, 75)'}}>
